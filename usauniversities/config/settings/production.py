...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["usauniversities.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="USAuniversities <noreply@usauniversities.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[USAuniversities]"
)
